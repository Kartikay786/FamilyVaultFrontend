      ...
      <div className="max-w-7xl mx-auto">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8 mb-12">
          ...
          <div className="col-span-1 md:col-span-2">
            <div className="flex items-center space-x-3 mb-4">
              ...
              <h3 className="text-2xl font-bold text-white">Family Vault</h3>
            </div>
          ...
          <div>
            ...
            <ul className="space-y-2">
              {['Smart Upload', 'Family Sharing', 'Memory Timeline', 'Custom Themes', 'Voice Notes', 'Secure Storage'].map((item) => (
                <li key={item}>
          ...
          <div>
            ...
            <ul className="space-y-2">
              {['Help Center', 'Privacy Policy', 'Terms of Service', 'Contact Us', 'API Docs', 'Status'].map((item) => (
                <li key={item}>
                  <a href="#" className="text-purple-200 hover:text-white transition-colors duration-300">
                    {item}
                  </a>
        ...
        <div className="border-t border-white/20 pt-8 flex flex-col md:flex-row items-center justify-between">
          <p className="text-purple-200 text-sm mb-4 md:mb-0">
            © 2024 Family Vault. Made with love for families worldwide.
          </p>
